...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Println("  -p, --pack string        Discovery Pack: standard, dns-extended, web-deep, api-focused, admin-stealth, full")
		...
		fmt.Println("\nVoorbeelden:")
		fmt.Println("  netmap -d voorbeeld.nl -p full")
		fmt.Println("  netmap -d voorbeeld.nl -f config")
